...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nueva venta plan canje</h5>
                    ...
                    <form method="POST" autocomplete="OFF">
                        <div id="step1_venta">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="imei_telefono_vender" type="text" name="telefono" placeholder="IMEI" autocomplete="OFF">
                            </div>
                            <div class="mb-3">
                                <label for="precio_lista" class="form-label">Precio de lista</label>
                                <input disabled type="number" step="0.01" class="form-control" id="precio_lista" name="precio_lista">
                            </div>
                            <div class="mb-3">
                                <label for="precio_mayorista" class="form-label">Precio mayorista</label>
                                <input disabled type="number" step="0.01" class="form-control" id="precio_mayorista" name="precio_mayorista">
                            </div>
                            <div class="mb-3">
                                <label for="precio_venta" class="form-label">Precio de venta</label>
                                <input disabled type="number" step="0.01" class="form-control" id="precio_venta" name="precio_venta">
                            </div>
                            <div class="mb-3">
                                <label for="costo" class="form-label">Costo</label>
                                <input disabled type="number" step="0.01" class="form-control" id="costo" name="costo">
                            </div>
                            <div class="mb-3">
                                <label for="fecha_ingreso" class="form-label">Fecha de ingreso</label>
                                <input disabled type="date" class="form-control" id="fecha_ingreso" name="fecha_ingreso">
                            </div>
                            <div class="mb-3">
                                <label for="bateria" class="form-label">Bateria</label>
                                <input disabled type="number" step="0.1" class="form-control" id="bateria" name="bateria">
                            </div>

                            <a id="siguiente" href="#">siguiente</a>
                        </div>
                        <div id="step2_venta" style="display: none;">
                            <div class="autocomplete">
    ...
    <script>
        ...
        var stock_telefonos = [
            <?php foreach (Productos::getTelefonos() as $telefono) : ?> "<?= $telefono['modelo'] . " " . $telefono['color'] . " - " . $telefono['capacidad'] . "GB |" . $telefono['id']  ?>",
            <?php endforeach; ?>
        ];
        ...
        autocomplete_2(document.getElementById("imei_telefono_vender"), stock_telefonos);
